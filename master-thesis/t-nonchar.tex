...
\begin{proof}
  ...
  \begin{proof}[Proof of Claim \ref{clm:ind-nonchar}]
    ...
    \]
    is isomorphic. 
    Let \(s\in \Gamma(Z_{s};F)\) be 
    a section of \(\mres[F]{Z_{s}}\). 
    By the isomorphism abve, we can extend \(s\) to 
    an open neighborhood \(U\) of \(Z_{s}\). 
    More precisely, there exists a family of pairs\[
      ((\tilde{s}_{U},U))_{U}
      \in 
      \bigsqcup_{U\supset Z_{s}}\Gamma(U;F)
    \] such that \(\mres[\tilde{s}_{U}]{Z_{s}}=s\) 
    for all \(U\). For this \((\tilde{s}_{U},U)_{U}\), 
    there exists a family of sections 
    \[
      (\hat{s}_{U},U)_{U}
      \in 
      \bigsqcup_{U\supset Z_{s}}\Gamma(U\cup U_t;F)
    \]
    such that \(\mres[\hat{s}_{U}]{U\cap U_{t}} = \mres[\tilde{s}_{U}]{U\cap U_{t}}\) for all \(U\). 
    Indeed, 
