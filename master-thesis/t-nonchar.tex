...
\begin{proof}
  ...
  \begin{align}
    ...
    H^{k}(U_{s};F).
  \end{align}
  Therefore, if we show Claim \ref{clm:ind-nonchar} below, 
  we have 
  \begin{align*}
  ...
  \begin{Claim+}\label{clm:ind-nonchar}
  ...
  \begin{proof}[Proof of Claim \ref{clm:ind-nonchar}]
  ...
  so, by applying 
  Proposition \ref{prop:ks2.7.1} (\ref{item:ks2.7.1.3})\footnote{
