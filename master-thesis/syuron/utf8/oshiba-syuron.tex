...
In this section, 
we recall some definitions and results from \cite{KS90}, 
...
\subsection{The Mittag-Leffler Condition}\label{ssec:ML}
...
\subsubsection*{ML procedure for sheaves}
...
\begin{Example+}\label{eg:t-nonchar}
  ...
  Proposition \ref{prp:t-nonchar} is not contained 
  in the original version (\cite[Proposition 2.7.2]{KS90}). 
