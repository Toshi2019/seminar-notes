...
\begin{proof}
  ...
  \begin{proof}[Proof of Lemma \ref{clm:ind-nonchar}]
    ...
    \begin{align*}
      ...
      &=\bigcap_{s<r<t}\overline{U_{r}}\cap (X \smallsetminus(U\cup U_{s}))\\
...
\section{An Application to Microlocal Morse Theory}
