...
complex of sheaves on \textcolor{darkgreen}{the} space. 
Roughly speaking, 
original version of this theorem asserts that 
if the family is ``noncharacteristic'', in a sense, 
with respect to the complex of sheaves, 
then we can obtain the natural isomorphism 
between the derived functors of the functors of 
...
the noncharacteristic deformation lemma\textcolor{darkgreen}
{, where Lemma \ref{clm:ind-nonchar} plays a crucial role. 
However, since the proof of the lemma is long 
and rather technical, 
its proof will be given in the last section of our paper.
}
