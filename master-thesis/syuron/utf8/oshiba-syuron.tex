...
introduced the notion of truncatd microsupprt in \cite{KFS03a}}, 
...
\textcolor{black}{
This lemma is one og the most fundamental result 
...
\textcolor{black}{Note that a} paracomact space 
...
\begin{Example+}\label{eg:t-nonchar}
  ...
  \begin{enumerate}[(i)]
    ...
    \]
    \textcolor{black}{For this \(Z\)} 
    we denote by \(\kk_{Z}\) the sheaf on \(X\) \textcolor{black}{as Section \ref{sec:review}}. 
    If \(j\leqq0\), we have \(
