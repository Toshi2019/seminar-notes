...
\begin{enumerate}[(1)]
	...
	%内部Hom関手\(\RHOM\)については
	超局所台は，
	打ち切り超局所台の関手的性質のいくつかは，
	普通の超局所台の関手的性質と同じように証明される．
	各次数のコホモロジーの延長可能性を超局所台を用いて
	%\cite{KS90}における超局所台の関手的性質の証明の仕方に
	%沿っている．
	そこで，
	\item \textbf{層係数Morse理論を精密化する．}
	\item \textbf{具体的な多様体での適用例を計算する．}
\end{enumerate}
