...
\vspace{-10pt}
\begin{enumerate}[(1)]
	\item \textbf{層係数Morse理論の精密化}\\
	打ち切り超局所台を用いることで，層係数Morse理論を精密化する．
	\item \textbf{打ち切り超局所台の関手的性質の探求}\\
	...
	性質を求める．
	\item \textbf{超局所的関手の打ち切り版の構成}\\
	超局所化関手や\(\mu hom\)関手をコホモロジーの次数に関して分解した，
...
\begin{center}
	...
	\begin{tabular}{cc}\toprule
		...
		2028（3年目）& (1) 超局所化関手と\(\mu hom\)関手の構成と性質の調査\\\bottomrule
	\end{tabular}
\end{center}
\end{table}
