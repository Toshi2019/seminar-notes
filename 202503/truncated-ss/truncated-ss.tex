...
\begin{proof}
  ...
  \]for each \(j\leqq k\). 
  Therefore, By the long exact sequence
  \begin{align*}
    0&\to 
    H^{0}\RG_{[a,b[}(\Rder{\psi}_{\ast}F)
    \to
    H^{0}\RG_{]-\infty,b[}(\Rder{\psi}_{\ast}F)
    \to
    H^{0}\RG_{]-\infty,a[}(\Rder{\psi}_{\ast}F)\\
    &\to 
    H^{1}\RG_{[a,b[}(\Rder{\psi}_{\ast}F)
    \to
    H^{1}\RG_{]-\infty,b[}(\Rder{\psi}_{\ast}F)
    \to
    H^{1}\RG_{]-\infty,a[}(\Rder{\psi}_{\ast}F)\\
    &\to\dots\\
    &\to 
    ...
    &\to
    H^{k+1}\RG_{[a,b[}(\Rder{\psi}_{\ast}F)\to\dots,
  \end{align*}
