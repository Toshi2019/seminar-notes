...
\begin{leftbar}
\begin{DFN}
    \textbf{単体圏} (simplex category)\footnote{\cite{KS06}では，
    単体的圏 (simplicial category) と呼んでいるが，
    Riehl とか，Riehl-Verity ではこう呼んでいたのでそちらに合わせる．
    Lurieでは別の概念を表すのに simplicial category を使っていたので
    衝突しないようにというのもある．} \(\cSimp\)を次で定める．
    \begin{align*}
