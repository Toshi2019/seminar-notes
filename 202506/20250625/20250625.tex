...
% documentclass
% ------------------------
\documentclass[leqno, 8pt, a4paper, dvipdfmx]{jsarticle}
\title{ゼミノート（06月25日分）}
\author{Toshi2019}
\date{\today}
...
\begin{proof}
  ...
  \begin{align*}
    ...
    \mdiff[{q_{13}}]^{-1}
    \micro{\diag[f]\dpb[Y]\diag[g]}\left(
      q_{12}^{-1}\RHOM(q_{2}^{-1}G,q_{1}^{!}F)
      \lltens[]
      q_{23}^{-1}\RHOM({q_{2}''}^{-1}H,{q_{1}''}^{!}G)
    \right)
    &&\text{（戻した）}\\
    &\to
    \mdiff[{q_{13}}]^{-1}
    \micro{\diag[f]\dpb[Y]\diag[g]}\left(
      q_{12}^{!}\RHOM(q_{2}^{-1}G,q_{1}^{!}F)
      \lltens[]\omega_{X\times Y\times Z/X\times Y}^{\otimes-1}
      \lltens[]
      q_{23}^{-1}\RHOM({q_{2}''}^{-1}H,{q_{1}''}^{!}G)
    \right)
    &&\text{（(3.1.6)に逆をかけた）}\\
    ...
    \micro{\diag[f]\dpb[Y]\diag[g]}\left(
      ...
      \lltens[]\omega_{X\times Y\times Z/X\times Y}^{\otimes-1}
      \lltens[]
      \RHOM(q_{13}^{-1}{q_{2}'}^{-1}H,q_{23}^{-1}({q_{1}''}^{-1}G\lltens[]\omega_{Y\times Z/Y}))
    \right)
    &&\text{（）}\\
    &\simar
    \mdiff[{q_{13}}]^{-1}
    \micro{\diag[f]\dpb[Y]\diag[g]}\left(
      \RHOM(q_{12}^{-1}q_{2}^{-1}G,q_{13}^{!}{q'_{1}}^{!}F)
      \lltens[]
      \omega_{X\times Y\times Z/X\times Y}^{\otimes-1}
      \lltens[]
      \RHOM(q_{13}^{-1}{q_{2}'}^{-1}H,q_{23}^{-1}{q_{1}''}^{-1}G\lltens[]q_{23}^{-1}\omega_{Y\times Z/Y})
    \right)
    &&\text{（）}\\
    &\simar
    \mdiff[{q_{13}}]^{-1}
    ...
    \lltens[]
    \omega_{X\times Y\times Z/X\times Y}^{\otimes-1}
    \lltens[]q_{23}^{-1}\omega_{Y\times Z/Y}
    &&\text{（）}\\
    &\to
    \mdiff[{q_{13}}]^{-1}
    \micro{\diag[f]\dpb[Y]\diag[g]}\left(      
