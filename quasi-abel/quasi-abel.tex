...
\paragraph{2023/09/15}

\cite{Sch99}を読む．
まずモチベーションについて．
解析ではフィルター加群や局所凸空間を考えることが多い．
それに対するホモロジー論を作っておくと便利だが，
これらの圏はアーベル圏にならない．
そこで，アーベル圏よりも少し条件を緩めた
「準アーベル圏」を考えようというのがモチベ．

もう一つは上記のような対象の圏に値を取る層に対しての
コホモロジー論としていいものを見つけたいというもの．

Quillenの意味での完全圏のうち特別なものとして準アーベル圏を定義する．
...
\subsection{像，余像，strict morphism\footnote{
    完全射・嵌合射・十全射・万全射のような訳語が考えられる．
}}

「余核の核」が像で，「核の余核」が余像．つまり\(\cE\)において
\begin{align*}
    \im(f\colon E\to F)
    &=\Ker\left(F\overset{p}{\longrightarrow}\Coker f\right),\\
    \Coim(f\colon E\to F)
    &=\Coker\left(\Ker\overset{i}{\longrightarrow}E\right).
\end{align*}
このとき，自然な射
\[\Coim f\to\im f\]
が存在する．
この射が同形であるとき，\(f\)はstrictであるという．

\subsection{準アーベル圏の定義}
\begin{DFN}
    圏\(\cE\)が準アーベル圏であるとは，
    次の互いに双対的な条件を満たすことをいう．
    \begin{description}
        \item[(QA)] デカルト図式\[
...
\begin{thebibliography}{20} 
    \bibitem[KS90]{KS90} Masaki Kashiwara, Pierre Schapira, 
        ...
        \bibitem[Sch99]{Sch99} Schneiders, \textit{Quasi-abelian categories}, , 1999.
\end{thebibliography}
