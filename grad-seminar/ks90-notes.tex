...
\begin{RMK}
    ...
    \begin{align}
        ...
        \cong
        \left(F_{1}\right)_{Z}\ttens[\scR]F_{2},\label{eq2317}\\
...
\end{RMK}
\begin{proof}
    \eqref{eq2317}：次の射の列を考える．

    \eqref{eq2318}：次の射の列を考える．

    \eqref{eq2319}：次の射の列を考える．

    \eqref{eq2320}：次の射の列を考える．
