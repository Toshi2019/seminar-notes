...
\subsubsection*{本研究計画の着想に至った経緯}
申請者は，修士論文で打切り超局所台を用いて，層係数Morse理論を
精密化した．これを微分方程式の解の層に適用すると，
境界を含まない，その内側で得られた解の一意延長性に関する，
ホルムグレンの一意性定理を大域化することができる．
今度は，境界上での値を与えたときにその延長はどうなるか，
ということに申請者は着目した．
%end 本研究の着想に至った経緯など ＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝
...
\paragraph{研究目的}
本研究の目的は，
連接\(\mathcal{D}\)加群のmild超関数解のなす層の打切り超局所台を
上から評価することである．
\paragraph{研究方法，研究内容}
片岡のmild超関数
