...
第1章で複素関数論の準備を行う．
第2章で偏微分方程式からの動機づけを述べる．
第3章と第4章でそれぞれSchwartzと佐藤幹夫による超関数の理論を紹介する．
第5章でHelgason予想への応用を述べる．
第6章で超局所解析を紹介する．

色々な設定が暗黙のうちに変わっていたり，
一変数の場合しか定義していない概念を多変数の場合に
用いたりすることがあるが，
ご寛恕されたい．
\section{複素関数論}
...
\begin{CNJ}[Helgason予想]
  一般の比コンパクト型リーマン対称空間上の同次固有関数の空間は，
  ``境界''上の佐藤超関数の空間とポアソン積分で同形であろう．
\end{CNJ}

\begin{THM}[\cite{KKKOOT78}]
  Helgason予想は正しい．
\end{THM}
...
\]
とおく．
\(\varOmega\)の余接束\(\cotb[\varOmega]\)を
\[
  \cotb[\varOmega]\coloneqq \varOmega \times \rr^n
\]
で定める．また，
\[
  \cotb[\varOmega]\coloneqq \varOmega \times (\rr^n\smi \left\{0\right\})
\]
とおく．
\begin{DFN}
...
\section*{おわりに}
参考文献の紹介をする．
前半の第2, 3, 5節は\cite{Ok97}に沿って述べた．
複素関数論について，\cite{J95}を挙げる．
\cite{J95}には佐藤超関数についての記述もある．
佐藤超関数については，
\cite{Kan96,Mori76}が有名な入門書である．
佐藤幹夫本人によるもの\cite{Sato58}も
ぜひ目を通すとよいと思う．
超局所解析も理論的に勉強するには\cite{KKK80}が挙げられる．

代数解析全般を導来圏の立場から述べるには，
層の超局所理論を用いるのが基本的である．
導来圏や層の（超局所）理論の専門書として，\cite{KS90}を挙げる．

Schwartzの分布の立場からの超局所解析については
\cite{ALPDO}を挙げる．
Helgason予想については，原論文\cite{KKKOOT78}の他に
\cite{MO77,Os85}も参考にした．
%===============================================
% 参考文献スペース
%===============================================
\begin{thebibliography}{20} 
  \bibitem[ALPDO]{ALPDO} Lars H\"ormander,
    \textit{The analysis of linear partial differential operators I}, 
    Grundlehren der Mathematischen Wissenschaften, 256, Springer, 1983.
  ...
  \bibitem[MO77]{MO77} 峰村勝弘, 大島利雄, 
  確定特異点型境界値問題と表現論, 数学 29 (1977), pp.243--253. 
  \bibitem[Ok97]{Ok97} 岡本清郷, 
  {フーリエ解析の展望}, すうがくぶっくす 17, 朝倉書店, 1997.
  \bibitem[Os85]{Os85} 大島利雄, 
  半単純対称空間上の調和解析, 数学 37 (1985), pp.97--112. 
