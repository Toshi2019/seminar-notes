...
%\layout
\chapter*{はじめに}
2025年8月から始めた\cite{Kon13}のセミナーのノート．
...
\appendix
\chapter{誤植とコメント}
ここでは，誤植と思われる箇所や不適当な記述を指摘する．
\begin{itemize}
    \item pp.9--10: 
    ベクトル束\(E\)の切断全体を\(\Gamma(E)\)で表すとあるが，
    p.10, l.12では\(\Gamma(U_{\alpha};\KK^r)\)という記号を
    用いている．
    これは\(U_{\alpha}\)上の自明束\(
        p_1\colon U_{\alpha}\times \KK^r\to U_{\alpha}
    \)上の切断全体のことであろう．
\end{itemize}
%===============================================
% 参考文献スペース
...
\begin{thebibliography}{20} 
    ...
    \bibitem[Kon13]{Kon13} 今野宏, 微分幾何学, 東京大学出版会, 2013.
    %\bibitem[Og02]{Og02} 小木曽啓示, 代数曲線論, 朝倉書店, 2002.
\end{thebibliography}
