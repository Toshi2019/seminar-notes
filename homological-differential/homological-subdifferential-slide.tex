...
\begin{frame}
    ...
    \begin{definition}[前層]
        ...
        \left(\mathscr{F}(U)\right)_{U\in\Op_{X}},
...
\begin{frame}\frametitle{層の複体の圏}
    \begin{Definition}[層の導来圏\(\Domp^b(k_X)\)]
        \[
            \Domp^b(k_X)\coloneqq \Domp^b(\Mod(k_X))
        \]
    \end{Definition}
\end{frame}
